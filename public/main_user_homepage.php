...
<head>
    ...
    <link rel="stylesheet" href="css/style.css"> <style>
        ...
        .lecture-card-grid {
            display: grid;
            grid-template-columns: repeat(minmax(100, 1fr));
            gap: 25px;
            margin-top: 20px;
            padding-bottom: 40px;
        }
        .lecture-card {
            ...
            border-radius: 15px;
            box-shadow: 0 6px 20px rgba(49, 197, 19, 0.1);
        ...
        .lecture-card:hover {
            ...
            box-shadow: 0 10px 25px rgba(201, 189, 26, 0.2);
        }
        .lecture-card .card-img {
            width: 100%;
            height: 300px;
            object-fit: cover;
            border-bottom: 3px solidrgb(69, 206, 42);
        }
                            ...
                            <div class="semester-main-section" id="semester_<?php echo sanitizeId($semester['id']); ?>_branch_<?php echo sanitizeId($branch['id']); ?>">
                                ...
                                <div class="row lecture-card-grid">
                                    ...
                                    foreach ($lectures_grouped_by_category as $category_id => $lectures_in_category) {
                                        ...
                                        ?>
                                        <div class="col-12">
                                            <h5 class="category-title" style="font-size:1.4rem; background: rgba(194, 22, 22, 0.7); padding: 8px; border-radius: 5px; margin-bottom: 15px;">
